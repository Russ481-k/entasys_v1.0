...
const trafficVersionMap: Record<PANOSVersion, string[]> = {
  '10.1': trafficColumnNames_10_1,
  '11.0': trafficColumnNames_11_0,
};

const systemVersionMap: Record<PANOSVersion, string[]> = {
  '10.1': systemColumnNames_10_1,
  '11.0': systemColumnNames_11_0,
};

const threatVersionMap: Record<PANOSVersion, string[]> = {
...
export function getTrafficColumnNames(version: PANOSVersion) {
  return trafficVersionMap[version];
}

export function getSystemColumnNames(version: PANOSVersion) {
  return systemVersionMap[version];
}

export function getThreatColumnNames(version: PANOSVersion) {
